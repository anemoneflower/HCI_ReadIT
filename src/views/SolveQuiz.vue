    ...
    <div class="body">
      <div class="checkList">
        <table id="check">
          <tbody>
            <tr>
              <td id="1" @click="move(1)">
                <CheckBox num="1" isQuiz="true" />
              </td>
              <td id="2" @click="move(2)">
                <CheckBox num="2" isQuiz="true" />
              </td>
              <td id="3" @click="move(3)">
                <CheckBox num="3" isQuiz="true" />
              </td>
              <td id="4" @click="move(4)">
                <CheckBox num="4" isQuiz="false" />
              </td>
            </tr>
          </tbody>
        </table>
